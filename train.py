...
medicines = pd.read_csv("baseDatos-completa.csv", header=0, delimiter=",", engine = "python", encoding = "utf-8")  #Obtaining the medicines names from the file
...
train = pd.read_csv("tweetsClasificados-3000.csv", header=0, delimiter=";", engine = "python", encoding = "utf-8")  #Obtaining training data
