...
medicines = pd.read_csv("baseDatos-completa.csv", header=0, delimiter=",", encoding = "utf-8")  #Obtaining the medicines names from the file
...
forest = joblib.load('logistic_regression')	#Loading already trained logistic regression and initializing vectorizer
...
def start_scrapping():	#Scrapping tweets, idea is do this about twice per day perhaps
	...
	for i in medicines_list:	#Then, do a querry for each different medicine
